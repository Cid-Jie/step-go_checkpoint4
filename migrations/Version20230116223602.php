 ...
 */
final class Version20230116223602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dance_classes_user_message (dance_classes_id INT NOT NULL, user_message_id INT NOT NULL, INDEX IDX_CF9ED69F286E79CF (dance_classes_id), INDEX IDX_CF9ED69FF41DD5C5 (user_message_id), PRIMARY KEY(dance_classes_id, user_message_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dance_teacher (id INT AUTO_INCREMENT NOT NULL, dance_classes_id INT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, story LONGTEXT NOT NULL, photo VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_FDD3884A286E79CF (dance_classes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_message (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, reason VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL, available_at DATETIME NOT NULL, delivered_at DATETIME DEFAULT NULL, INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE dance_classes_user_message ADD CONSTRAINT FK_CF9ED69F286E79CF FOREIGN KEY (dance_classes_id) REFERENCES dance_classes (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE dance_classes_user_message ADD CONSTRAINT FK_CF9ED69FF41DD5C5 FOREIGN KEY (user_message_id) REFERENCES user_message (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dance_classes_user_message DROP FOREIGN KEY FK_CF9ED69F286E79CF');
        ...
        $this->addSql('ALTER TABLE dance_classes_user_message DROP FOREIGN KEY FK_CF9ED69FF41DD5C5');
        $this->addSql('DROP TABLE dance_classes');
        $this->addSql('DROP TABLE dance_classes_user_message');
