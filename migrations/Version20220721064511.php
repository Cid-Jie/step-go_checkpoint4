 ...
 */
final class Version20220721064511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_message (id INT AUTO_INCREMENT NOT NULL, dance_classes_id INT DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, reason VARCHAR(255) NOT NULL, message LONGTEXT DEFAULT NULL, INDEX IDX_EEB02E75286E79CF (dance_classes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
