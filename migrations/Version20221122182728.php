 ...
 */
final class Version20221122182728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_calendar (id INT AUTO_INCREMENT NOT NULL, dance_classes_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, description LONGTEXT NOT NULL, is_all_day TINYINT(1) NOT NULL, background_color VARCHAR(7) NOT NULL, isRecurring INT NOT NULL, start_recur DATETIME DEFAULT NULL, end_recur DATETIME DEFAULT NULL, INDEX IDX_28454896286E79CF (dance_classes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
