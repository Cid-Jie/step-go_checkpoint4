 ...
 */
<<<<<<< HEAD:migrations/Version20230116213327.php
final class Version20230116213327 extends AbstractMigration
=======
final class Version20230116205305 extends AbstractMigration
>>>>>>> 5ff89b3cd0952f05ea9ee6d617009777769eb10c:migrations/Version20230116205305.php
{
...
<<<<<<< HEAD:migrations/Version20230116213327.php
        $this->addSql('CREATE TABLE dance_classes (id INT AUTO_INCREMENT NOT NULL, user_message_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, poster VARCHAR(255) NOT NULL, INDEX IDX_4FC8505AF41DD5C5 (user_message_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
>>>>>>> 5ff89b3cd0952f05ea9ee6d617009777769eb10c:migrations/Version20230116205305.php
        ...
        $this->addSql('ALTER TABLE dance_classes ADD CONSTRAINT FK_4FC8505AF41DD5C5 FOREIGN KEY (user_message_id) REFERENCES user_message (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dance_classes DROP FOREIGN KEY FK_4FC8505AF41DD5C5');
