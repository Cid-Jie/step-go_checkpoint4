 ...
 */
final class Version20221127143939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_planning (id INT AUTO_INCREMENT NOT NULL, dance_classes_id INT DEFAULT NULL, days_of_week INT NOT NULL, hours_of_day INT NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_92755626286E79CF (dance_classes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event_planning ADD CONSTRAINT FK_92755626286E79CF FOREIGN KEY (dance_classes_id) REFERENCES dance_classes (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event_planning DROP FOREIGN KEY FK_92755626286E79CF');
