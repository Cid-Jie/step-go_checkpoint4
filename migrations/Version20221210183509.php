 ...
 */
final class Version20221210183509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7286E79CF FOREIGN KEY (dance_classes_id) REFERENCES dance_classes (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA78AFDA0EB FOREIGN KEY (dance_class_id) REFERENCES dance_classes (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
